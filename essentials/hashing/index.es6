exports.crypt = { 
	...
	,base64_encode : (			string) => new Buffer.from(string).toString('base64')

	//BASE64 DECODE A STRING
	,base64_decode : 		(string) => new Buffer.from( new Buffer.from(string,'base64').toString('hex'), 'hex').toString('utf8')
